...
module lab9_soc_mm_interconnect_0 (
		...
		output wire [1:0]  onchip_memory2_0_s2_address,                        //                      onchip_memory2_0_s2.address
		...
		output wire [1:0]  vram_s1_address,                                    //                                  vram_s1.address
	...
	wire  [106:0] cmd_mux_013_src_data;                                                               // cmd_mux_013:src_data -> onchip_memory2_0_s1_agent:cp_data
	...
	wire   [28:0] vram_s1_agent_m0_address;                                                           // vram_s1_agent:m0_address -> vram_s1_translator:uav_address
	...
	wire  [107:0] vram_s1_agent_rf_source_data;                                                       // vram_s1_agent:rf_source_data -> vram_s1_agent_rsp_fifo:in_data
	...
	wire  [107:0] vram_s1_agent_rsp_fifo_out_data;                                                    // vram_s1_agent_rsp_fifo:out_data -> vram_s1_agent:rf_sink_data
	...
	wire          cmd_mux_014_src_valid;                                                              // cmd_mux_014:src_valid -> vram_s1_agent:cp_valid
	wire  [106:0] cmd_mux_014_src_data;                                                               // cmd_mux_014:src_data -> vram_s1_agent:cp_data
	wire          cmd_mux_014_src_ready;                                                              // vram_s1_agent:cp_ready -> cmd_mux_014:src_ready
	wire   [15:0] cmd_mux_014_src_channel;                                                            // cmd_mux_014:src_channel -> vram_s1_agent:cp_channel
	wire          cmd_mux_014_src_startofpacket;                                                      // cmd_mux_014:src_startofpacket -> vram_s1_agent:cp_startofpacket
	wire          cmd_mux_014_src_endofpacket;                                                        // cmd_mux_014:src_endofpacket -> vram_s1_agent:cp_endofpacket
	...
	wire          cmd_mux_015_src_valid;                                                              // cmd_mux_015:src_valid -> onchip_memory2_0_s2_agent:cp_valid
	wire  [106:0] cmd_mux_015_src_data;                                                               // cmd_mux_015:src_data -> onchip_memory2_0_s2_agent:cp_data
	wire          cmd_mux_015_src_ready;                                                              // onchip_memory2_0_s2_agent:cp_ready -> cmd_mux_015:src_ready
	wire   [15:0] cmd_mux_015_src_channel;                                                            // cmd_mux_015:src_channel -> onchip_memory2_0_s2_agent:cp_channel
	wire          cmd_mux_015_src_startofpacket;                                                      // cmd_mux_015:src_startofpacket -> onchip_memory2_0_s2_agent:cp_startofpacket
	wire          cmd_mux_015_src_endofpacket;                                                        // cmd_mux_015:src_endofpacket -> onchip_memory2_0_s2_agent:cp_endofpacket
	...
	wire  [106:0] onchip_memory2_0_s1_agent_rp_data;                                                  // onchip_memory2_0_s1_agent:rp_data -> router_015:sink_data
	...
	wire          vram_s1_agent_rp_valid;                                                             // vram_s1_agent:rp_valid -> router_016:sink_valid
	wire  [106:0] vram_s1_agent_rp_data;                                                              // vram_s1_agent:rp_data -> router_016:sink_data
	wire          vram_s1_agent_rp_ready;                                                             // router_016:sink_ready -> vram_s1_agent:rp_ready
	wire          vram_s1_agent_rp_startofpacket;                                                     // vram_s1_agent:rp_startofpacket -> router_016:sink_startofpacket
	wire          vram_s1_agent_rp_endofpacket;                                                       // vram_s1_agent:rp_endofpacket -> router_016:sink_endofpacket
	...
	wire          onchip_memory2_0_s2_agent_rp_valid;                                                 // onchip_memory2_0_s2_agent:rp_valid -> router_017:sink_valid
	wire  [106:0] onchip_memory2_0_s2_agent_rp_data;                                                  // onchip_memory2_0_s2_agent:rp_data -> router_017:sink_data
	wire          onchip_memory2_0_s2_agent_rp_ready;                                                 // router_017:sink_ready -> onchip_memory2_0_s2_agent:rp_ready
	wire          onchip_memory2_0_s2_agent_rp_startofpacket;                                         // onchip_memory2_0_s2_agent:rp_startofpacket -> router_017:sink_startofpacket
	wire          onchip_memory2_0_s2_agent_rp_endofpacket;                                           // onchip_memory2_0_s2_agent:rp_endofpacket -> router_017:sink_endofpacket
	...
	wire   [15:0] cmd_demux_001_src4_channel;                                                         // cmd_demux_001:src4_channel -> cmd_mux_013:sink1_channel
	...
	wire   [15:0] cmd_demux_001_src5_channel;                                                         // cmd_demux_001:src5_channel -> cmd_mux_014:sink1_channel
	...
	wire          cmd_demux_001_src6_valid;                                                           // cmd_demux_001:src6_valid -> cmd_mux_015:sink1_valid
	wire  [106:0] cmd_demux_001_src6_data;                                                            // cmd_demux_001:src6_data -> cmd_mux_015:sink1_data
	wire          cmd_demux_001_src6_ready;                                                           // cmd_mux_015:sink1_ready -> cmd_demux_001:src6_ready
	wire   [15:0] cmd_demux_001_src6_channel;                                                         // cmd_demux_001:src6_channel -> cmd_mux_015:sink1_channel
	wire          cmd_demux_001_src6_startofpacket;                                                   // cmd_demux_001:src6_startofpacket -> cmd_mux_015:sink1_startofpacket
	wire          cmd_demux_001_src6_endofpacket;                                                     // cmd_demux_001:src6_endofpacket -> cmd_mux_015:sink1_endofpacket
	...
	wire   [15:0] rsp_demux_013_src1_channel;                                                         // rsp_demux_013:src1_channel -> rsp_mux_001:sink4_channel
	...
	wire   [15:0] rsp_demux_014_src1_channel;                                                         // rsp_demux_014:src1_channel -> rsp_mux_001:sink5_channel
	...
	wire          rsp_demux_015_src1_valid;                                                           // rsp_demux_015:src1_valid -> rsp_mux_001:sink6_valid
	wire  [106:0] rsp_demux_015_src1_data;                                                            // rsp_demux_015:src1_data -> rsp_mux_001:sink6_data
	wire          rsp_demux_015_src1_ready;                                                           // rsp_mux_001:sink6_ready -> rsp_demux_015:src1_ready
	wire   [15:0] rsp_demux_015_src1_channel;                                                         // rsp_demux_015:src1_channel -> rsp_mux_001:sink6_channel
	wire          rsp_demux_015_src1_startofpacket;                                                   // rsp_demux_015:src1_startofpacket -> rsp_mux_001:sink6_startofpacket
	wire          rsp_demux_015_src1_endofpacket;                                                     // rsp_demux_015:src1_endofpacket -> rsp_mux_001:sink6_endofpacket
	...
	wire          vram_s1_agent_rdata_fifo_src_valid;                                                 // vram_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_014:in_0_valid
	wire   [33:0] vram_s1_agent_rdata_fifo_src_data;                                                  // vram_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_014:in_0_data
	wire          vram_s1_agent_rdata_fifo_src_ready;                                                 // avalon_st_adapter_014:in_0_ready -> vram_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_014_out_0_valid;                                                  // avalon_st_adapter_014:out_0_valid -> vram_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_014_out_0_data;                                                   // avalon_st_adapter_014:out_0_data -> vram_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_014_out_0_ready;                                                  // vram_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_014:out_0_ready
	wire    [0:0] avalon_st_adapter_014_out_0_error;                                                  // avalon_st_adapter_014:out_0_error -> vram_s1_agent:rdata_fifo_sink_error
	wire          onchip_memory2_0_s2_agent_rdata_fifo_src_valid;                                     // onchip_memory2_0_s2_agent:rdata_fifo_src_valid -> avalon_st_adapter_015:in_0_valid
	wire   [33:0] onchip_memory2_0_s2_agent_rdata_fifo_src_data;                                      // onchip_memory2_0_s2_agent:rdata_fifo_src_data -> avalon_st_adapter_015:in_0_data
	wire          onchip_memory2_0_s2_agent_rdata_fifo_src_ready;                                     // avalon_st_adapter_015:in_0_ready -> onchip_memory2_0_s2_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_015_out_0_valid;                                                  // avalon_st_adapter_015:out_0_valid -> onchip_memory2_0_s2_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_015_out_0_data;                                                   // avalon_st_adapter_015:out_0_data -> onchip_memory2_0_s2_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_015_out_0_ready;                                                  // onchip_memory2_0_s2_agent:rdata_fifo_sink_ready -> avalon_st_adapter_015:out_0_ready
	wire    [0:0] avalon_st_adapter_015_out_0_error;                                                  // avalon_st_adapter_015:out_0_error -> onchip_memory2_0_s2_agent:rdata_fifo_sink_error
	...
	lab9_soc_mm_interconnect_0_router_004 router_015 (
	...
	lab9_soc_mm_interconnect_0_router_004 router_017 (
	...
	lab9_soc_mm_interconnect_0_cmd_mux_002 cmd_mux_013 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab9_soc_mm_interconnect_0_cmd_mux_002 cmd_mux_015 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab9_soc_mm_interconnect_0_rsp_demux_002 rsp_demux_013 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab9_soc_mm_interconnect_0_rsp_demux_002 rsp_demux_015 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
