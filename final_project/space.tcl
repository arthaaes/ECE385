...
# File: space.tcl
# Generated on: Sat May 31 19:23:10 2025
...
if {[is_project_open]} {
	if {[string compare $quartus(project) "space"]} {
		puts "Project space is not open"
		set make_assignments 0
	}
} else {
	# Only open if not already open
	if {[project_exists space]} {
		project_open -revision space space
	} else {
		project_new -revision space space
	}
...
if {$make_assignments} {
	...
	set_global_assignment -name TOP_LEVEL_ENTITY top_level_space_invaders
	set_global_assignment -name ORIGINAL_QUARTUS_VERSION 18.1.0
	set_global_assignment -name PROJECT_CREATION_TIME_DATE "18:59:40  APRIL 29, 2025"
	...
	set_global_assignment -name SYSTEMVERILOG_FILE win_page.sv
	set_global_assignment -name SYSTEMVERILOG_FILE starting.sv
	set_global_assignment -name SYSTEMVERILOG_FILE ship_health_rom.sv
	set_global_assignment -name SYSTEMVERILOG_FILE ship_health_map.sv
	set_global_assignment -name SYSTEMVERILOG_FILE player_rom.sv
	set_global_assignment -name SYSTEMVERILOG_FILE lose_page.sv
	set_global_assignment -name SYSTEMVERILOG_FILE enemy_rom2.sv
	set_global_assignment -name SYSTEMVERILOG_FILE enemy_rom1.sv
	set_global_assignment -name SYSTEMVERILOG_FILE enemy_rom0.sv
	set_global_assignment -name SYSTEMVERILOG_FILE enemy_active_flags.sv
	set_global_assignment -name SYSTEMVERILOG_FILE digit_rom.sv
	set_global_assignment -name SYSTEMVERILOG_FILE alien_rom.sv
	set_global_assignment -name SYSTEMVERILOG_FILE alien_map.sv
	set_global_assignment -name SYSTEMVERILOG_FILE top_level_space_invaders.sv
	set_global_assignment -name SYSTEMVERILOG_FILE player_missile_ctrl.sv
	set_global_assignment -name SYSTEMVERILOG_FILE player_control.sv
	set_global_assignment -name SYSTEMVERILOG_FILE game_fsm.sv
	set_global_assignment -name SYSTEMVERILOG_FILE enemy_missile_ctrl.sv
	set_global_assignment -name SYSTEMVERILOG_FILE enemy_logic.sv
	set_global_assignment -name SYSTEMVERILOG_FILE detect_collision.sv
	set_global_assignment -name SYSTEMVERILOG_FILE score_tracker.sv
	set_global_assignment -name SYSTEMVERILOG_FILE sprite_rom_mistery.sv
	...
	set_global_assignment -name VERILOG_FILE vga_clk.v
	set_global_assignment -name QIP_FILE vga_clk.qip
	set_global_assignment -name SOURCE_FILE vga_clk.ppf
	set_global_assignment -name SOURCE_FILE lab8.qsf
	...
	set_global_assignment -name SYSTEMVERILOG_FILE heart_rom.sv
	set_global_assignment -name SYSTEMVERILOG_FILE mystery_controller.sv
	set_global_assignment -name SYSTEMVERILOG_FILE life_drop_controller.sv
