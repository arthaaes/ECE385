...
(
    ...
    localparam PAD2 = log2ceil(64'h2001040 - 64'h2001030); 
    ...
    localparam PAD10 = log2ceil(64'h20010c0 - 64'h20010b0); 
    localparam PAD11 = log2ceil(64'h20010d0 - 64'h20010c8); 
    localparam PAD12 = log2ceil(64'h20010d8 - 64'h20010d0); 
    // -------------------------------------------------------
    // Work out which address bits are significant based on the
    // address range of the slaves. If the required width is too
    // large or too small, we use the address field width instead.
    // -------------------------------------------------------
    localparam ADDR_RANGE = 64'h20010d8;
    ...
    // ( 0x20010c8 .. 0x20010d0 )
    if ( {address[RG:PAD11],{PAD11{1'b0}}} == 26'h20010c8   ) begin
            src_channel = 13'b0000000000001;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 0;
    end

    // ( 0x20010d0 .. 0x20010d8 )
    if ( {address[RG:PAD12],{PAD12{1'b0}}} == 26'h20010d0  && read_transaction  ) begin
